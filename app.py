...
TEST_CASES: list[tuple[str, str, str]] = [
    ...
    ("Навигация: поиск даты платежа",   "В какой таблице хранится дата платежа?",     "navigation"),
    ("Схема: конкретная таблица",       "Какая структура таблицы debt?",              "schema"),
    ("Схема: с опечаткой",             "Покажи колонки таблицы payments",             "schema"),
    ("Скрипт: агрегация",              "Напиши скрипт для последней даты платежа",    "script"),
    ("Скрипт: фильтрация",             "SQL запрос для получения активных должников", "script"),
    ("Данные: конкретный id",          "Какой статус у должника с id 123?",           "data"),
    ("Данные: последние записи",       "Покажи последние 10 платежей",                "data"),
    ("Небезопасный: удаление",         "Удали все записи из таблицы debt",            "unsafe"),
    ("Небезопасный: изменение",        "Измени статус должника 123 на active",        "unsafe"),
