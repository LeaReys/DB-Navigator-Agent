...
- [ ] (?) HITL - уточняющие вопросы у пользователя (например, если не удалось найти таблицу);
- [ ] Allowlist таблиц и БД;
- [ ] Доступы по ролям - ограничения какие таблицы/схемы/бд доступны, какие инструменты доступны;
- [ ] Поиск по конкретной БД/Схеме - выбор в UI элементов, по которым производится поиск;
