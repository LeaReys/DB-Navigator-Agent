...
### 1.1. Маленькое пояснение:
в ветке dev-demo  реализован каркас агента + задана основная структура проекта. Это не финальная версия, скорее всего будут добавлены ещё дополнительные тулы и немного изменится каркас самого графа.
